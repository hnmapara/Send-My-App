...
import com.mapara.sendmyapp.helper.DeviceInfo;
 ...
 */
public class SendAppApplication extends Application
                                implements DeviceInfo {

    private static final String TAG = SendAppApplication.class.getSimpleName();
